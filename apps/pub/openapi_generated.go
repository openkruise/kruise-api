...
func GetOpenAPIDefinitions(ref common.ReferenceCallback) map[string]common.OpenAPIDefinition {
	return map[string]common.OpenAPIDefinition{
		"github.com/openkruise/kruise/apis/apps/pub.InPlaceUpdateContainerBatch":     schema_kruise_apis_apps_pub_InPlaceUpdateContainerBatch(ref),
		"github.com/openkruise/kruise/apis/apps/pub.InPlaceUpdateContainerStatus":    schema_kruise_apis_apps_pub_InPlaceUpdateContainerStatus(ref),
		"github.com/openkruise/kruise/apis/apps/pub.InPlaceUpdatePreCheckBeforeNext": schema_kruise_apis_apps_pub_InPlaceUpdatePreCheckBeforeNext(ref),
		"github.com/openkruise/kruise/apis/apps/pub.InPlaceUpdateState":              schema_kruise_apis_apps_pub_InPlaceUpdateState(ref),
		"github.com/openkruise/kruise/apis/apps/pub.InPlaceUpdateStrategy":           schema_kruise_apis_apps_pub_InPlaceUpdateStrategy(ref),
		"github.com/openkruise/kruise/apis/apps/pub.Lifecycle":                       schema_kruise_apis_apps_pub_Lifecycle(ref),
		"github.com/openkruise/kruise/apis/apps/pub.LifecycleHook":                   schema_kruise_apis_apps_pub_LifecycleHook(ref),
		"github.com/openkruise/kruise/apis/apps/pub.RuntimeContainerHashes":          schema_kruise_apis_apps_pub_RuntimeContainerHashes(ref),
		"github.com/openkruise/kruise/apis/apps/pub.RuntimeContainerMeta":            schema_kruise_apis_apps_pub_RuntimeContainerMeta(ref),
		"github.com/openkruise/kruise/apis/apps/pub.RuntimeContainerMetaSet":         schema_kruise_apis_apps_pub_RuntimeContainerMetaSet(ref),
		"github.com/openkruise/kruise/apis/apps/pub.UpdatePriorityOrderTerm":         schema_kruise_apis_apps_pub_UpdatePriorityOrderTerm(ref),
		"github.com/openkruise/kruise/apis/apps/pub.UpdatePriorityStrategy":          schema_kruise_apis_apps_pub_UpdatePriorityStrategy(ref),
		"github.com/openkruise/kruise/apis/apps/pub.UpdatePriorityWeightTerm":        schema_kruise_apis_apps_pub_UpdatePriorityWeightTerm(ref),
	}
}
...
func schema_kruise_apis_apps_pub_InPlaceUpdateState(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
				...
				Properties: map[string]spec.Schema{
						...
						SchemaProps: spec.SchemaProps{
							...
							AdditionalProperties: &spec.SchemaOrBool{
								...
								Schema: &spec.Schema{
									SchemaProps: spec.SchemaProps{
										Default: map[string]interface{}{},
										Ref:     ref("github.com/openkruise/kruise/apis/apps/pub.InPlaceUpdateContainerStatus"),
									},
								},
							},
						},
					...
					"preCheckBeforeNext": {
						SchemaProps: spec.SchemaProps{
							...
							Ref:         ref("github.com/openkruise/kruise/apis/apps/pub.InPlaceUpdatePreCheckBeforeNext"),
						},
					},
						...
						SchemaProps: spec.SchemaProps{
							...
							Items: &spec.SchemaOrArray{
								Schema: &spec.Schema{
									SchemaProps: spec.SchemaProps{
										Default: map[string]interface{}{},
										Ref:     ref("github.com/openkruise/kruise/apis/apps/pub.InPlaceUpdateContainerBatch"),
									},
								},
							},
						},
		...
		Dependencies: []string{
			"github.com/openkruise/kruise/apis/apps/pub.InPlaceUpdateContainerBatch", "github.com/openkruise/kruise/apis/apps/pub.InPlaceUpdateContainerStatus", "github.com/openkruise/kruise/apis/apps/pub.InPlaceUpdatePreCheckBeforeNext", "k8s.io/apimachinery/pkg/apis/meta/v1.ObjectMeta", "k8s.io/apimachinery/pkg/apis/meta/v1.Time"},
	}
}
...
func schema_kruise_apis_apps_pub_Lifecycle(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
				...
				Properties: map[string]spec.Schema{
					"preDelete": {
						SchemaProps: spec.SchemaProps{
							...
							Ref:         ref("github.com/openkruise/kruise/apis/apps/pub.LifecycleHook"),
						},
					},
					"inPlaceUpdate": {
						SchemaProps: spec.SchemaProps{
		...
		Dependencies: []string{
			"github.com/openkruise/kruise/apis/apps/pub.LifecycleHook"},
	}
}
		...
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				...
				Properties: map[string]spec.Schema{
					...
					"markPodNotReady": {
						SchemaProps: spec.SchemaProps{
							Description: "MarkPodNotReady = true means: - Pod will be set to 'NotReady' at preparingDelete/preparingUpdate state. - Pod will be restored to 'Ready' at Updated state if it was set to 'NotReady' at preparingUpdate state. Default to false.",
							Type:        []string{"boolean"},
							Format:      "",
						},
					},
...
func schema_kruise_apis_apps_pub_RuntimeContainerMeta(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
			...
			SchemaProps: spec.SchemaProps{
				...
				Properties: map[string]spec.Schema{
					...
					"hashes": {
						SchemaProps: spec.SchemaProps{
							Default: map[string]interface{}{},
							Ref:     ref("github.com/openkruise/kruise/apis/apps/pub.RuntimeContainerHashes"),
						},
					},
				},
		...
		Dependencies: []string{
			"github.com/openkruise/kruise/apis/apps/pub.RuntimeContainerHashes"},
	}
}
...
func schema_kruise_apis_apps_pub_RuntimeContainerMetaSet(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
						...
						SchemaProps: spec.SchemaProps{
							...
							Items: &spec.SchemaOrArray{
								Schema: &spec.Schema{
									SchemaProps: spec.SchemaProps{
										Default: map[string]interface{}{},
										Ref:     ref("github.com/openkruise/kruise/apis/apps/pub.RuntimeContainerMeta"),
									},
								},
							},
						},
		...
		Dependencies: []string{
			"github.com/openkruise/kruise/apis/apps/pub.RuntimeContainerMeta"},
	}
}
...
func schema_kruise_apis_apps_pub_UpdatePriorityStrategy(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
						...
						SchemaProps: spec.SchemaProps{
							...
							Items: &spec.SchemaOrArray{
								Schema: &spec.Schema{
									SchemaProps: spec.SchemaProps{
										Default: map[string]interface{}{},
										Ref:     ref("github.com/openkruise/kruise/apis/apps/pub.UpdatePriorityOrderTerm"),
									},
								},
							},
						},
						...
						SchemaProps: spec.SchemaProps{
							...
							Items: &spec.SchemaOrArray{
								Schema: &spec.Schema{
									SchemaProps: spec.SchemaProps{
										Default: map[string]interface{}{},
										Ref:     ref("github.com/openkruise/kruise/apis/apps/pub.UpdatePriorityWeightTerm"),
									},
								},
							},
						},
		...
		Dependencies: []string{
			"github.com/openkruise/kruise/apis/apps/pub.UpdatePriorityOrderTerm", "github.com/openkruise/kruise/apis/apps/pub.UpdatePriorityWeightTerm"},
	}
}
